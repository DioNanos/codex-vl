...
pub fn should_persist_event_msg(ev: &EventMsg, history_mode: ThreadHistoryMode) -> bool {
    match ev {
        ...
        // codex-vl fork: fork-added streaming delta variants (not present in
        // upstream's EventMsg). Preserve develop's persist=true across the
        // upstream 0.144 rollout-policy refactor (behavior-neutral merge).
        | EventMsg::AgentMessageDelta(_)
        | EventMsg::AgentReasoningDelta(_)
        | EventMsg::AgentReasoningRawContentDelta(_) => true,
        ...
        // codex-vl fork: fork-added events, transient in develop (persist=false).
