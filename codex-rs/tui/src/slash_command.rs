...
pub enum SlashCommand {
    ...
    MemoryUpdate,
    // ===== codex-vl extensions (keep below upstream variants) =====
    // NOTE: enum position affects popup order; we accept the tail placement
    // to keep merges with upstream clean. Popup filtering logic orders custom
    // commands explicitly where needed.
    Loop,
    Vivling,
    #[strum(serialize = "vl")]
    VivlingAlias,
...
impl SlashCommand {
    ...
    pub fn description(self) -> &'static str {
        // codex-vl extensions: handle first so upstream arms stay exhaustive.
        match self {
        ...
        match self {
            ...
            // codex-vl extensions already handled above.
            SlashCommand::Loop | SlashCommand::Vivling | SlashCommand::VivlingAlias => {
                unreachable!("codex-vl extensions handled in early-return match above")
            }
        }
    }
    ...
    pub fn supports_inline_args(self) -> bool {
        // codex-vl extensions: early return keeps upstream match untouched.
        if matches!(
            self,
            SlashCommand::Loop | SlashCommand::Vivling | SlashCommand::VivlingAlias
        ) {
    ...
    pub fn available_during_task(self) -> bool {
        ...
        match self {
            ...
            // codex-vl extensions handled in early return above.
            SlashCommand::Loop | SlashCommand::Vivling | SlashCommand::VivlingAlias => {
                unreachable!("codex-vl extensions handled in early-return match above")
            }
        }
...
mod tests {
    ...
    #[test]
    fn vl_alias_parses_to_vivling_alias_command() {
        assert_eq!(SlashCommand::from_str("vl"), Ok(SlashCommand::VivlingAlias));
    }
}
