...
// Animated cycles (2 frames each, exact-width per cycle — Codex iter 7 §1).
...
// Young Adult — animated.

const YOUNG_ADULT_IDLE: &[[&str; 3]] = &[
    ["  \\.o./  ", " o-/|\\-o ", "  _/ \\_  "],
    ["  \\.o./. ", " o-/|\\-o ", "  _/ \\_  "],
];

const YOUNG_ADULT_WORK: &[[&str; 3]] = &[
    ["  \\.o./  ", " o=/|\\=o ", "  _/ \\_  "],
    ["  \\.o./  ", " o=/|\\=o.", "  _/ \\_  "],
];

const YOUNG_ADULT_THINK: &[[&str; 3]] = &[
    ["  \\.o./? ", " o-/|\\-o ", "  _/ \\_  "],
    ["  \\.o./. ", " o-/|\\-o ", "  _/ \\_  "],
];

const YOUNG_ADULT_HAPPY: &[[&str; 3]] = &[
    ["  \\^o^/* ", " o-/|\\-o ", "  _/ \\_  "],
    ["  \\.o./* ", " o-/|\\-o ", "  _/ \\_  "],
];
