...
const BABY_IDLE: [&str; 3] = ["  .-o-.  ", " -( o )- ", "  /___\\  "];

const BABY_WORK: [&str; 3] = ["  .-o-.  ", " -(>o)-  ", "  /___\\  "];

const BABY_THINK: [&str; 3] = ["  .-o-.? ", " -( o )- ", "  /___\\  "];

const BABY_HAPPY: [&str; 3] = ["  .-o-.* ", " -(^o)^- ", "  /___\\  "];

const BABY_SLEEP: [&str; 3] = ["  .-o-.z ", " -(-o)-  ", "  /___\\  "];

const BABY_ALERT: [&str; 3] = ["  .-o-.! ", " -( Oo)- ", "  /___\\  "];

const BABY_SUCCESS: [&str; 3] = ["  .-o-.v ", " -(^o)^- ", "  /___\\  "];

const BABY_ERROR: [&str; 3] = ["  .-o-.x ", " -( xo)- ", "  /___\\  "];

const JUVENILE_IDLE: [&str; 3] = ["   .o.   ", " -<( )>- ", "  _/ \\_  "];

const JUVENILE_WORK: [&str; 3] = ["   .o./  ", " -<( )>- ", "  _/o\\_  "];
...
const YOUNG_ADULT_IDLE: [&str; 3] = ["  \\.o./  ", " o-/|\\-o ", "  _/ \\_  "];

const YOUNG_ADULT_WORK: [&str; 3] = ["  \\.o./  ", " o=/|\\=o ", "  _/ \\_  "];

const YOUNG_ADULT_THINK: [&str; 3] = ["  \\.o./? ", " o-/|\\-o ", "  _/ \\_  "];

const YOUNG_ADULT_HAPPY: [&str; 3] = ["  \\^o^/* ", " o-/|\\-o ", "  _/ \\_  "];

const YOUNG_ADULT_SLEEP: [&str; 3] = ["  \\-o-/z ", " o-/|\\-o ", "  _/ \\_  "];

const YOUNG_ADULT_ALERT: [&str; 3] = ["  \\o!o/  ", " o-/|\\-o ", "  _/ \\_  "];

const YOUNG_ADULT_SUCCESS: [&str; 3] = ["  \\^o^/v ", " o-/|\\-o ", "  _/ \\_  "];

const YOUNG_ADULT_ERROR: [&str; 3] = ["  \\xox/x ", " o-/|\\-o ", "  _/ \\_  "];
