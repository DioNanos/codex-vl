...
// All cycles are single-frame for now (mythic, reserved). Wrapped in
// `&[[..]]` len=1 so they pass through the new multi-frame signature
// without behavioural change. Future iters can extend any cycle to
