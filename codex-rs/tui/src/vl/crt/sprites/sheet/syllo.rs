...
// Each frame keeps the same width across the cycle so `compose_at` does not
// recenter on tick advance.
...
const BABY_SLEEP: &[[&str; 3]] = &[["  .-o-.z ", " /(- -)\\ ", "  /_<_\\  "]];

const BABY_ALERT: &[[&str; 3]] = &[["  .-o-.! ", " /( o )\\ ", "  /_<_\\  "]];

const BABY_SUCCESS: &[[&str; 3]] = &[["  .-o-.v ", " /(^o^)\\ ", "  /_<_\\  "]];

const BABY_ERROR: &[[&str; 3]] = &[["  .-o-.x ", " /( x )\\ ", "  /_<_\\  "]];
...
const YOUNG_ADULT_ERROR: &[[&str; 3]] = &[["  \\xox/x ", " --/|\\-- ", "  _/ \\_  "]];
