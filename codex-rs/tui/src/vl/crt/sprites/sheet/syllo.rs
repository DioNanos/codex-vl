...
const BABY_IDLE: [&str; 3] = ["  .-o-.  ", " /(   )\\ ", "  /_<_\\  "];

const BABY_WORK: [&str; 3] = ["  .-o-.  ", " /(> )]\\ ", "  /_<_\\  "];

const BABY_THINK: [&str; 3] = ["  .-o-.? ", " /(   )\\ ", "  /_<_\\  "];

const BABY_HAPPY: [&str; 3] = ["  .-o-.* ", " /(^ ^)\\ ", "  /_<_\\  "];
...
const JUVENILE_IDLE: [&str; 3] = ["   .o.   ", "  /(_)\\  ", " _/|<|\\_ "];

const JUVENILE_WORK: [&str; 3] = ["   .o.[] ", "  /(_)\\  ", " _/|<|\\_ "];

const JUVENILE_THINK: [&str; 3] = ["   .o.?  ", "  /(_)\\  ", " _/|<|\\_ "];
