...
fn catalog_model_json_with_persistent_instructions(len: usize) -> serde_json::Value {
    serde_json::json!({
        "slug": "catalog-test-model",
...
#[test]
fn local_catalog_loader_accepts_exact_limit_and_rejects_oversized_messages() {
