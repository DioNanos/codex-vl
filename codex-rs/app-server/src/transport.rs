...
impl ConnectionState {
    pub(crate) fn new(
        ...
        authority_verifier: Option<Arc<dyn crate::identity::AuthorityVerifier>>,
    ) -> Self {
        let mut session = ConnectionSessionState::new();
        session.set_authority_verifier(authority_verifier);
        Self {
            origin,
