...
For issues in the fork's own code — Codex VL features (`/vivling`, `/loop`, `/goal`, `/vl`,
remote-control), Termux/Android compatibility patches, fork-owned CI and release workflows, or
npm packaging — please report privately:
