...
release_url_for_asset() {
  ...
  printf 'https://github.com/DioNanos/codex-vl/releases/download/v%s/%s\n' "$resolved_version" "$asset"
}

release_metadata_url() {
  resolved_version="$1"

  printf 'https://api.github.com/repos/DioNanos/codex-vl/releases/tags/v%s\n' "$resolved_version"
}
...
resolve_version() {
  ...
  release_json="$(download_text "https://api.github.com/repos/DioNanos/codex-vl/releases/latest")"
...
handle_conflicting_install() {
  ...
  case "$conflict_manager" in
    brew)
      ...
      ;;
    bun)
      uninstall_cmd="bun remove -g @mmmbuto/codex-vl"
      ;;
    *)
      uninstall_cmd="npm uninstall -g @mmmbuto/codex-vl"
      ;;
  esac
