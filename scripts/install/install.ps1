...
function Get-ReleaseAssetMetadata {
    ...
    $release = Invoke-RestMethod -Uri "https://api.github.com/repos/DioNanos/codex-vl/releases/tags/v$ResolvedVersion"
...
function Resolve-Version {
    ...
    $release = Invoke-RestMethod -Uri "https://api.github.com/repos/DioNanos/codex-vl/releases/latest"
...
function Maybe-HandleConflictingInstall {
    ...
    $uninstallArgs = if ($manager -eq "bun") {
        @("remove", "-g", "@mmmbuto/codex-vl")
    } else {
        @("uninstall", "-g", "@mmmbuto/codex-vl")
    }
